...
namespace Orbifold.Numerics
{
	...
	/// </summary>
	/// <seealso cref="http://en.wikipedia.org/wiki/Diehard_tests"/>
	public static class MultiplyWithCarryRandomGenerator
	{
		/// <summary>The.</summary>
		...
		/// <summary>
		/// Initializes the <see cref="Orbifold.Numerics.Sampling"/> class.
		/// </summary>
		static MultiplyWithCarryRandomGenerator()
		{
		...
		/// <summary>
		/// Returns a random number with a Weibull probability distribution.
		/// </summary>
		/// <seealso cref="http://en.wikipedia.org/wiki/Weibull_distribution"/>
		/// <exception cref="T:System.ArgumentOutOfRangeException"></exception>
		public static double GetWeibull(double shape, double scale)
		{
			if(shape <= 0.0 || scale <= 0.0)
				throw new ArgumentOutOfRangeException(string.Format("Shape and scale parameters must be positive. Recieved shape {0} and scale{1}.", shape, scale));
