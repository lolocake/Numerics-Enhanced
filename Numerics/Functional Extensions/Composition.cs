...
namespace Orbifold.Numerics
{
	...
	public static class Composition
	{
		...
		/// <param name="action">The action.</param>
		/// <returns></returns>
		public static Action<TDomain1, TDomain2, TDomain3, TDomain4, TDomain5, TDomain6, TDomain7> Compose<TDomain1, TDomain2, TDomain3, TDomain4, TDomain5, TDomain6, TDomain7, TIR